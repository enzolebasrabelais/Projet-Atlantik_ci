...
class ModeleTarif extends Model
{
    ...
    public function getAllTarifsDUneLiaison($noliaison = null)
    {
        $condition = ['tar.NOLIAISON'=>$noliaison];

        return $this
        ->join('type t', 'tar.lettrecategorie = t.lettrecategorie', 'tar.notype = t.notype', 'inner')
